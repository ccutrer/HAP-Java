...
public class FaultCharacteristic extends BooleanCharacteristic implements EventableCharacteristic {
  ...
  public FaultCharacteristic(
    ...
    super("00000077-0000-1000-8000-0026BB765291", false, true, null);
    this.getter = getter;
