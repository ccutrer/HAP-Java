...
public class TamperedCharacteristic extends BooleanCharacteristic
  ...
  public TamperedCharacteristic(
      Supplier<CompletableFuture<Boolean>> getter,
      Consumer<HomekitCharacteristicChangeCallback> subscriber,
      Runnable unsubscriber) {
    super("0000007A-0000-1000-8000-0026BB765291", false, true, null);
    this.getter = getter;
